...
// **********ST7735 TFT*******************
// ST7735
// Backlight (pin 8) notconnected
// TFT_CS (pin 7) connected to PA3 (SSI0Fss)
// Data/Command (pin 6) connected to PE4 (GPIO), high for data, low for command
// RESET (pin 5) connected to PE5 (GPIO)
// MOSI (pin 4) connected to PA5 (SSI0Tx)
// SCK (pin 3) connected to PA2 (SSI0Clk)
...
#define CS_PIN                  GPIO_PIN_3 // PA3
#define RESET_PIN               GPIO_PIN_5 // PE5
#define DC_PIN                  GPIO_PIN_4 // PE4

#define LCD_CS_HIGH             GPIOPinWrite(GPIO_PORTA_BASE, CS_PIN, CS_PIN)
#define LCD_DC_LOW              GPIOPinWrite(GPIO_PORTA_BASE, CS_PIN, 0)

#define LCD_DC_COMMAND          GPIOPinWrite(GPIO_PORTE_BASE, DC_PIN, 0)
#define LCD_DC_DATA             GPIOPinWrite(GPIO_PORTE_BASE, DC_PIN, DC_PIN)
#define LCD_RES_SET             GPIOPinWrite(GPIO_PORTE_BASE, RESET_PIN, RESET_PIN)
#define LCD_RES_CLR             GPIOPinWrite(GPIO_PORTE_BASE, RESET_PIN, 0)
...
void static commonInit(const uint8_t *cmdList) {
    ...
    GPIOPinTypeGPIOOutput(GPIO_PORTE_BASE, DC_PIN | RESET_PIN);
