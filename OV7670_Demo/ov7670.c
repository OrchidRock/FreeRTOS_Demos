...
/*
 * D0-D7 : PB0-PB7
 * VSYNC: PA2, HREF: PA4, PCLK: PA3, XLCK: PD0-PWM
 */
void OV7670_GPIO_Init(void)
{
    ...
    GPIOPinTypeGPIOInput(GPIO_PORTA_BASE, VSYNC_PIN | PCLK_PIN | HREF_PIN);
    
    // XCLK PD0
    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOD);
    SysCtlPeripheralEnable(SYSCTL_PERIPH_PWM0);   
    GPIOPinConfigure(GPIO_PD0_M0PWM6);
    GPIOPinTypePWM(GPIO_PORTD_BASE, XCLK_PIN);
    
    PWMGenConfigure(PWM0_BASE, PWM_GEN_0, PWM_GEN_MODE_UP_DOWN | PWM_GEN_MODE_NO_SYNC); 
    PWMOutputState(PWM0_BASE, PWM_OUT_6_BIT, true);
    PWMGenPeriodGet(PWM0_BASE, PWM_GEN_0, );
    PWMPulseWidthSet(PWM0_BASE, PWM_OUT_6, PWMGenPeriodGet(PWM0_BASE, PWM_GEN_0) / 2); // 50% duty
